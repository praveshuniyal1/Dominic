...
- (void)setUp
{
   // self.backgroundColor = [UIColor groupTableViewBackgroundColor];
    ...
    _backgroundColors[@(LGCalendarCellStateSelected)]    = [UIColor grayColor];
    _backgroundColors[@(LGCalendarCellStatePlaceholder)] = [UIColor clearColor];
    _backgroundColors[@(LGCalendarCellStateToday)]       = [UIColor colorWithRed:(40.0/255.0) green:(124/255.0) blue:(184/255.0) alpha:1] ;
    ...
    _titleColors[@(LGCalendarCellStateWeekend)]       = [UIColor darkGrayColor];
